...
class Robot(RCareWorldBaseObject):
    ...
    def setJointVelocitiesDirectly(self, joint_velocities: list):
        """

        @param joint_velocities: a list of the desired velocity for each joint
        @return:
        """
        self.env.instance_channel.set_action(
            "SetJointVelocityDirectly", id=self.id, joint_velocities=joint_velocities
        )
